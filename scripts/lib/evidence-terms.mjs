...
export const PILLAR_TERMS = {
  ...
  daily_life_consumer: ["ePortugal", "Livro de Reclamações", "ANACOM", "energia", "arbitragem de consumo", "fidelização", "ANACOM", "livre resolução", "garantia", "comercializador", "ERSE", "tarifa social", "serviços públicos essenciais", "prescrição", "ANAC", "direitos dos passageiros", "RGPD", "CNPD", "ruído", "SIAC", "recenseamento eleitoral", "julgado de paz", "arbitragem"],
};
