...
export const PILLAR_TERMS = {
  ...
  social_security: ["Segurança Social", "Segurança Social Direta", "carreira contributiva", "declaração trimestral", "contribuições", "NISS", "trabalhador independente", "subsídio parental", "pensão de velhice", "fator de sustentabilidade", "subsídio de doença", "CIT"],
  housing_property: ["arrendamento", "IMI", "AIMI", "IMT", "imóvel", "caderneta predial", "certidão permanente", "registo predial", "Imposto do Selo", "habitação própria permanente", "VPT", "oposição à renovação", "NRAU", "rendimentos prediais", "categoria F", "Porta 65"],
