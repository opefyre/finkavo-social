...
export const PILLAR_TERMS = {
  ...
  irs: ["IRS", "Modelo 3", "e-Fatura", "Anexo J", "IRS Automático", "IRS Jovem", "IAS", "taxa liberatória", "Modelo 30", "retenção na fonte", "dedução à coleta", "despesas de saúde", "IFICI", "residente não habitual", "reclamação graciosa", "juros de mora", "mínimo de existência", "união de facto", "tributação conjunta"],
