...
export const PILLAR_TERMS = {
  ...
  driving_transport: ["IMT", "carta de condução", "IUC", "veículo", "passe", "Circula PT", "troca de carta", "título de condução", "inspeção periódica", "IPO", "registo de propriedade", "revalidação", "atestado médico", "seguro automóvel", "declaração amigável"],
